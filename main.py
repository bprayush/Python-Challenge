...
for i in range(0, len(source) - 7):
    if source[i].isupper() and source[i+1].isupper() and source[i+2].isupper() and source[i+3].islower() and source[i+4].isupper() and source[i+5].isupper() and source[i+6].isupper():
        text = source[i] + source[i+1] + source[i+2] + source[i+3] + source[i+4] + source[i+5] + source[i+6]
        # print(source[i+3], end='')
        if source[i+3] == 'l':
            print(text)
        # if source[i+3] in stack:
        #     count = stack[source[i+3]] + 1
        #     stack.update({source[i+3]: count})
        # else:
        #     stack[source[i+3]] = 1
